...
class TranslucentWidget(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.penColor = QtGui.QColor("#ffffff")

        self.popup_fillColor = QtGui.QColor(20, 10, 20, 255)
        self.popup_penColor = QtGui.QColor(20, 20, 20, 255)
        ...
        self.close_btn.setStyleSheet("background-color: rgba(240, 0, 0, 0);color:#f1f1f1;")
    ...
    def paintEvent(self, event):
        ...
        font.setBold(True)
        qp.setFont(font)
        qp.setPen(QtGui.QColor(255, 120, 70))
        tolw, tolh = 80, -5
